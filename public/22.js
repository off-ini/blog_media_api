...
/***/ "./resources/js/components/store/actions/VideoActions.js":
/*!***************************************************************!*\
  !*** ./resources/js/components/store/actions/VideoActions.js ***!
  \***************************************************************/
/*! exports provided: index, padding, get, show, store, edit, remove */
...
var index = function index() {
  return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(_core__WEBPACK_IMPORTED_MODULE_0__["default"].HOST + "/videos");
};
var padding = function padding(pageNumber, elementNumber) {
  return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(_core__WEBPACK_IMPORTED_MODULE_0__["default"].HOST + "/videos/padding/".concat(elementNumber, "?page=").concat(pageNumber));
};
var get = function get(search) {
  return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(_core__WEBPACK_IMPORTED_MODULE_0__["default"].HOST + "/videos" + search);
};
var show = function show(id) {
  return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(_core__WEBPACK_IMPORTED_MODULE_0__["default"].HOST + "/videos/" + id);
};
var store = function store(params) {
  return axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(_core__WEBPACK_IMPORTED_MODULE_0__["default"].HOST + "/videos", params);
};
var edit = function edit(id, data) {
  return axios__WEBPACK_IMPORTED_MODULE_1___default.a.put(_core__WEBPACK_IMPORTED_MODULE_0__["default"].HOST + "/videos/" + id, data);
};
var remove = function remove(id) {
  return axios__WEBPACK_IMPORTED_MODULE_1___default.a["delete"](_core__WEBPACK_IMPORTED_MODULE_0__["default"].HOST + "/videos/" + id);
};
...
/***/ "./resources/js/components/views/video/edit.jsx":
/*!******************************************************!*\
  !*** ./resources/js/components/views/video/edit.jsx ***!
  \******************************************************/
/*! exports provided: default */
...
/* harmony import */ var react_video_thumbnail__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! react-video-thumbnail */ "./node_modules/react-video-thumbnail/dist/bundle.js");
/* harmony import */ var react_video_thumbnail__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(react_video_thumbnail__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _store_actions_type__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../store/actions/type */ "./resources/js/components/store/actions/type.js");
/* harmony import */ var _store_actions_VideoActions__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../store/actions/VideoActions */ "./resources/js/components/store/actions/VideoActions.js");
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../core */ "./resources/js/components/core/index.js");
/* harmony import */ var _utils_message__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../utils/message */ "./resources/js/components/utils/message.js");
/* harmony import */ var _utils_errors__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../utils/errors */ "./resources/js/components/utils/errors.js");
...
var Edit = /*#__PURE__*/function (_Component) {
  ...
  function Edit(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSnapshot", function (e, val) {
      console.log(val);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleThumbnail", function (t) {
      console.log(t);
    ...
    _defineProperty(_assertThisInitialized(_this), "get", function () {
      ...
      if (id != null) {
        var reviver = videos.find(function (v) {
          return v.id === id;
        });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSubmit", function (e) {
      ...
      if (id != null) {
        edit(id, options).then(function (res) {
          dispatch({
            type: _store_actions_type__WEBPACK_IMPORTED_MODULE_15__["EDIT_VIDEO"],
            payload: res.data
          });

          _this.handleNull();

          _utils_message__WEBPACK_IMPORTED_MODULE_18__["defaultSuccess"](_this.props);
          handleClose(null);
        })["catch"](function (e) {
          Object(_utils_errors__WEBPACK_IMPORTED_MODULE_19__["default"])(e, dispatch, history);
          _utils_message__WEBPACK_IMPORTED_MODULE_18__["defaultError"](_this.props);
        ...
        store(options).then(function (res) {
          dispatch({
            type: _store_actions_type__WEBPACK_IMPORTED_MODULE_15__["CREATE_VIDEO"],
            payload: res.data
          });
  ...
  _createClass(Edit, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_Dialog__WEBPACK_IMPORTED_MODULE_5__["default"], {
      ...
      }, id != null ? "Modifier Video" : "Ajouter un Video"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_DialogContent__WEBPACK_IMPORTED_MODULE_7__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Row"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Col"], {
        xs: "12",
        md: "12"
        ...
        error: _utils_message__WEBPACK_IMPORTED_MODULE_18__["is_msg"](errors, 'title'),
        autoFocus: true,
        margin: "dense",
        label: "Titre",
        name: "title",
        ...
        fullWidth: true,
        variant: "outlined",
        helperText: _utils_message__WEBPACK_IMPORTED_MODULE_18__["fildsMsgHandler"](errors, 'title'),
      ...
      }), _utils_message__WEBPACK_IMPORTED_MODULE_18__["fildsMsgHandler"](this.state.errors, 'categories'))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Col"], {
        xs: "12",
        md: "12"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "form-group has-float-label"
        ...
        options: tags,
        placeholder: "Tags"
      }), _utils_message__WEBPACK_IMPORTED_MODULE_18__["fildsMsgHandler"](this.state.errors, 'tags'))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Col"], {
        xs: "12",
        md: "12"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "form-group has-float-label"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_video_thumbnail__WEBPACK_IMPORTED_MODULE_14___default.a, {
        videoUrl: "".concat(_core__WEBPACK_IMPORTED_MODULE_17__["default"].VIDEOS_URL, "/").concat(url),
        thumbnailHandler: function thumbnailHandler(thumbnail) {
          return _this2.handleThumbnail(thumbnail);
        } // renderThumbnail={false}
        ,
        snapshotAtTime: snapshot // width={width}
        // height={height}
...
var mapDispatchToProsps = function mapDispatchToProsps(dispatch) {
  return {
    ...
    store: function store(data) {
      return _store_actions_VideoActions__WEBPACK_IMPORTED_MODULE_16__["store"](data);
    },
    edit: function edit(id, data) {
      return _store_actions_VideoActions__WEBPACK_IMPORTED_MODULE_16__["edit"](id, data);
    }
  };
};
...
/***/ "./resources/js/components/views/video/index.jsx":
/*!*******************************************************!*\
  !*** ./resources/js/components/views/video/index.jsx ***!
  \*******************************************************/
/*! exports provided: default */
...
/* harmony import */ var _store_actions_VideoActions__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ../../store/actions/VideoActions */ "./resources/js/components/store/actions/VideoActions.js");
/* harmony import */ var _store_actions_CategorieActions__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ../../store/actions/CategorieActions */ "./resources/js/components/store/actions/CategorieActions.js");
/* harmony import */ var _store_actions_TagActions__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ../../store/actions/TagActions */ "./resources/js/components/store/actions/TagActions.js");
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ../../core */ "./resources/js/components/core/index.js");
/* harmony import */ var _utils_message__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ../../utils/message */ "./resources/js/components/utils/message.js");
/* harmony import */ var _utils_errors__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ../../utils/errors */ "./resources/js/components/utils/errors.js");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./edit */ "./resources/js/components/views/video/edit.jsx");
/* harmony import */ var _show__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./show */ "./resources/js/components/views/video/show.jsx");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var Video = /*#__PURE__*/function (_Component) {
  ...
  function Video(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleShowClose", function (v) {
      _this.setState({
        video: v
      }, function () {
        _this.setState({
    ...
    _defineProperty(_assertThisInitialized(_this), "handleActive", function (id) {
      ...
      axios.get(_core__WEBPACK_IMPORTED_MODULE_35__["default"].HOST + "/videos/active/" + id).then(function (res) {
        dispatch({
          type: _store_actions_type__WEBPACK_IMPORTED_MODULE_31__["EDIT_VIDEO"],
          payload: res.data
        });
      })["catch"](function (e) {
        Object(_utils_errors__WEBPACK_IMPORTED_MODULE_37__["default"])(e, dispatch, history);
        _utils_message__WEBPACK_IMPORTED_MODULE_36__["defaultError"](_this.props);
      })["finally"](function () {
        return _this.setState({
          loading: false
        });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleDelete", function (id) {
      ...
      remove(id).then(function (res) {
        dispatch({
          type: _store_actions_type__WEBPACK_IMPORTED_MODULE_31__["DELETE_VIDEO"],
          payload: res.data.id
        });
        _utils_message__WEBPACK_IMPORTED_MODULE_36__["defaultSuccess"](_this.props);
    ...
    _defineProperty(_assertThisInitialized(_this), "handlePageChange", function (event, pageNumber) {
      ...
      all(pageNumber + 1).then(function (res) {
        dispatch({
          type: _store_actions_type__WEBPACK_IMPORTED_MODULE_31__["ALL_VIDEOS"],
        ...
        return Object(_utils_errors__WEBPACK_IMPORTED_MODULE_37__["default"])(e, dispatch, history);
      });
    });
  ...
  _createClass(Video, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_breadcrumb__WEBPACK_IMPORTED_MODULE_5__["default"], {
      ...
      }), " ")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_4__["Row"], null, videos.map(function (video, i) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_4__["Col"], {
          ...
          onClick: function onClick() {
            _this3.handleShowClose(video);
          }
        }, video.thumbnail ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
          src: "".concat(_core__WEBPACK_IMPORTED_MODULE_35__["default"].THUMNAILS_VIDEO_URL, "/").concat(video.thumbnail),
          alt: video.title,
          height: 200,
          width: "100%"
          ...
          component: "h2",
          noWrap: true
        }, video.title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_IconButton__WEBPACK_IMPORTED_MODULE_22__["default"], {
          onClick: function onClick() {
            _this3.handleAddClose(video.id);
          },
          "aria-label": "info about ".concat(video.title),
          ...
          onClick: function onClick() {
            _this3.handleDelClose(video.id);
          },
          "aria-label": "info about ".concat(video.title),
          className: classes.icon
      ...
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_edit__WEBPACK_IMPORTED_MODULE_38__["default"], {
        open: this.state.openAdd,
        handleClose: this.handleAddClose,
        id: this.state.id
      }), this.state.video ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_show__WEBPACK_IMPORTED_MODULE_39__["default"], {
        open: this.state.openShow,
        handleClose: this.handleShowClose,
        video: this.state.video
      }) : null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_Dialog__WEBPACK_IMPORTED_MODULE_9__["default"], {
...
var mapDispatchToProsps = function mapDispatchToProsps(dispatch) {
  return {
    ...
    all_cat: function all_cat() {
      return _store_actions_CategorieActions__WEBPACK_IMPORTED_MODULE_33__["index"]();
    },
    all_tag: function all_tag() {
      return _store_actions_TagActions__WEBPACK_IMPORTED_MODULE_34__["index"]();
    },
    all: function all(n) {
      return _store_actions_VideoActions__WEBPACK_IMPORTED_MODULE_32__["padding"](n, 44);
    },
    remove: function remove(id) {
      return _store_actions_VideoActions__WEBPACK_IMPORTED_MODULE_32__["remove"](id);
    }
  };
};
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_material_ui_core_styles__WEBPACK_IMPORTED_MODULE_16__["withStyles"])(styles, {
  withTheme: true
})(Object(notistack__WEBPACK_IMPORTED_MODULE_2__["withSnackbar"])(Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps, mapDispatchToProsps)(Video))));

/***/ }),

/***/ "./resources/js/components/views/video/show.jsx":
/*!******************************************************!*\
  !*** ./resources/js/components/views/video/show.jsx ***!
  \******************************************************/
/*! exports provided: default */
...
/* harmony import */ var _store_actions_VideoActions__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../store/actions/VideoActions */ "./resources/js/components/store/actions/VideoActions.js");
  ...
  _createClass(Show, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_Dialog__WEBPACK_IMPORTED_MODULE_3__["default"], {
        ...
        "aria-labelledby": "alert-dialog-slide-title",
        "aria-describedby": "alert-dialog-slide-description"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_DialogContent__WEBPACK_IMPORTED_MODULE_5__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "player-wrapper"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_player__WEBPACK_IMPORTED_MODULE_8___default.a, {
        className: "react-player",
        url: "".concat(_core__WEBPACK_IMPORTED_MODULE_11__["default"].VIDEOS_URL, "/").concat(video.url),
        controls: true,
        width: "100%",
        height: "100%"
      })))));
...
var mapDispatchToProsps = function mapDispatchToProsps(dispatch) {
  return {
    dispatch: dispatch,
    all: function all(n) {
      return _store_actions_VideoActions__WEBPACK_IMPORTED_MODULE_10__["padding"](n, 44);
    }
  };
};
