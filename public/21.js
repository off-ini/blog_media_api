...
/***/ "./resources/js/components/views/video/create.jsx":
/*!********************************************************!*\
  !*** ./resources/js/components/views/video/create.jsx ***!
  \********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _store_actions_VideoActions__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../store/actions/VideoActions */ "./resources/js/components/store/actions/VideoActions.js");
...
var Create = /*#__PURE__*/function (_Component) {
  ...
  function Create(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "createFile", function (name, file) {
      var reader = new FileReader();

      reader.onload = function (e) {
        var videos = _this.state[name];

        if (!videos.find(function (e) {
          return e.name === file.name;
        })) {
          videos = [].concat(_toConsumableArray(videos), [{
          ...
          _this.setState(_defineProperty({}, name, videos));
        }
      };
    ...
    _defineProperty(_assertThisInitialized(_this), "onLoadedMetadata", function (e, i) {
      var videos = _this.state.videos;
      var v = videos[i];
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSubmit", function (e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_27___default.a.post(_core__WEBPACK_IMPORTED_MODULE_26__["default"].HOST + "/videos", options, {
  ...
  _createClass(Create, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_breadcrumb__WEBPACK_IMPORTED_MODULE_17__["default"], {
        ...
        message: "Glisser d\xE9poser des videos"
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Col"], {
        xs: "12",
        md: "12"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Row"], null, videos.map(function (img, i) {
...
var mapDispatchToProsps = function mapDispatchToProsps(dispatch) {
  return {
    ...
    store: function store(data) {
      return _store_actions_VideoActions__WEBPACK_IMPORTED_MODULE_20__["store"](data);
    }
  };
};
