...
import * as actionsCreator from '../../store/actions/CategorieActions';
...
class Create extends Component {
    ...
    get = () => {
        ...
        if(id != null)
        {
            const reviver = categories.find( v => v.id === id);
            if(reviver)
            {
...
<div>
    <Dialog
      ...
      >
        <DialogTitle id="alert-dialog-slide-title">{id != null ? "Modifier Catégorie" :"Ajouter une Catégorie"}</DialogTitle>
        <DialogContent>
            <Row>
                <Col xs="12" md="12">
                    <TextField
